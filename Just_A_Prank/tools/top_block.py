...
# Title: BPSK PLB Uplink
# Author: Abraxas3d
# Copyright: Public Domain
# Description: BPSK modulator for the Personal Locator Beacon signal for Deviations Capture the Flag for GNU Radio Conference 2020.
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "BPSK PLB Uplink")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK PLB Uplink")
        ...
        self.samp_rate = samp_rate = 400*sps
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(nfilts, nfilts, 1.0/float(sps), 0.35, 11*sps*nfilts)
        self.plb_frequency = plb_frequency = 406040000 + doppler
        self.pi = pi = 3.14159
        self.my_hdr = my_hdr = digital.header_format_default(digital.packet_utils.default_access_code,3, 1)
        self.my_bpsk = my_bpsk = digital.constellation_rect([0.45 + 0.89j, 0.45 - 0.89j], [0, 1],
        1, 1, 2, 1, 1).base()
        self.excess_bw = excess_bw = 0.35
        self.burst_T = burst_T = 1
        ...
        self.rational_resampler_xxx_0 = filter.rational_resampler_ccc(
                interpolation=4*250000//samp_rate,
                decimation=4,
                taps=None,
                fractional_bw=None)
        ...
        self.digital_constellation_modulator_0 = digital.generic_mod(
            ...
            verbose=False,
            log=False)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('/home/abraxas3d/Documents/Deviations/2457521.099641204_FridayNight5.wav', 2, 250000, 8)
        self.blocks_vector_source_x_1 = blocks.vector_source_b([0,0,0,0,0,0,0,0], False, 1, [])
        self.blocks_vector_source_x_0 = blocks.vector_source_b([255, 254, 47, 213, 39, 128, 0, 1, 77, 0, 8, 128, 202, 197, 13, 3, 238, 187,0,0,0,0,0], False, 1, [])
        self.blocks_tagged_stream_to_pdu_0 = blocks.tagged_stream_to_pdu(blocks.byte_t, 'packet_len')
        self.blocks_tagged_stream_mux_0 = blocks.tagged_stream_mux(gr.sizeof_char*1, 'packet_len', 0)
        self.blocks_stream_to_tagged_stream_1 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 8, "packet_len")
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 18+5, "packet_len")
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_message_debug_0 = blocks.message_debug()
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.analog_sig_source_x_0 = analog.sig_source_c(250000, analog.GR_COS_WAVE, 100000+doppler, 1, 0, 0)
    ...
    def set_sps(self, sps):
        ...
        self.set_samp_rate(400*self.sps)
    ...
    def set_doppler(self, doppler):
        ...
        self.analog_sig_source_x_0.set_frequency(100000+self.doppler)
    ...
    def get_burst_T(self):
        return self.burst_T

    def set_burst_T(self, burst_T):
